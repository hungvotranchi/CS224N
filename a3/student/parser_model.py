...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        embed_to_hidden = F.relu(embed @ self.embed_to_hidden_weight + self.embed_to_hidden_bias)
        logits = self.dropout(embed_to_hidden) @ self.hidden_to_logits_weight + self.hidden_to_logits_bias
        ### END YOUR CODE
        return logits
